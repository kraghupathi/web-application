...
class TestName(TestCase):
    ...
    def test_name_type(self):
        ...
        # incorrect name
        self.assertRaises(TypeError, Name, "123abcd")
#+END_SRC
...
class TestEmail(TestCase):
    ...
    def test_email_type(self):
        ...
        new_email = Email("raghu@gmail.com")
        # correct name
        self.assertEqual(new_email.value, "raghu@gmail.com")
        # incorrect name
        self.assertRaises(TypeError, Email, "@@@@raghugmail.com")
#+END_SRC
...
#+BEGIN_SRC python :tangle ../../tests/test_db.py :eval no
    def test_get_user_by_id(self):
        ...
        self.assertEqual(user.get_by_id(2).name, "raghu pathi")
#+END_SRC
...
#+BEGIN_SRC python :tangle ../../tests/test_db.py :eval no
    def test_update_user(self):
        ...
        #u_role = Role("user")
        #u_role.save()
        u1.update(name="john rod", 
                  email="john@gmail.com",
                  role=Role.get_by_id(2))
        print u1.to_client()
        self.assertEqual(u1.get_by_id(1).name, "john rod")
